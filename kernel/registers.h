...
#define SCTLR_EL1_LSMAOE \
	BIT(29) /* Load Multiple and Store Multiple Atomicity and Ordering Enable */
#define SCTLR_EL1_nTLSMD \
	BIT(28) /* No Trap Load Multiple and Store Multiple to Device-nGRE/Device-nGnRE/Device-nGnRnE memory */
#define SCTLR_EL1_EnDA BIT(27) /* Controls enabling of pointer authentication */
#define SCTLR_EL1_UCI \
	BIT(26) /* Traps EL0 execution of cache maintenance instructions to EL1, from AArch64 state only */
#define SCTLR_EL1_EE \
	BIT(25) /* Endianness of data accesses at EL1, and stage 1 translation table walks in the EL1&0 translation regime */
...
#define SCTLR_EL1_nTWE \
	BIT(18) /* Traps EL0 execution of WFE instructions to EL1, from both Execution states */
#define SCTLR_EL1_nTWI \
	BIT(16) /* Traps EL0 execution of WFI instructions to EL1, from both Execution states */
#define SCTLR_EL1_UCT \
	BIT(15) /* Traps EL0 accesses to the CTR_EL0 to EL1, from AArch64 state only */
#define SCTLR_EL1_DZE \
	BIT(15) /* Traps EL0 execution of DC ZVA instructions to EL1, from AArch64 state only */
...
#define SCTLR_EL1_UMA \
	BIT(9) /* User Mask Access: Traps EL0 execution of MSR and MRS instructions that access the PSTATE.{D, A, I, F} */
